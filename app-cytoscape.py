...
# * Purpose: visualize general NYC demographics data as a network
# * Date started: 2021-04-04
# * Authors: Xin Chen, Ian S. McBride, Lifu Tao
#
# This app was started using an official Plotly sample app as a base.
# That sample app was written by JP Hwang (https://www.jphwang.com/). A
# demo of that sample app is available here
# (https://dash-gallery.plotly.host/dash-cytoscape-lda/). The source for
# that sample app, which includes dataset files, is available here
# (https://github.com/plotly/dash-sample-apps/tree/master/apps/dash-cytoscape-lda)
...
network_df = pd.read_csv("data/sample_vis/network_df_sm.csv", index_col=0)  # ~4700 nodes
...
with open("data/sample_vis/lda_topics.json", "r") as f:
...
with open("data/sample_vis/startup_elms.json", "r") as f:
    startup_elms = json.load(f)

# TODO - startup dataset
